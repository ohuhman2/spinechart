...
## 6. 랜드마크 정의 (논문 기반 — Evidence-Based)

> **⚠️ 핵심: 랜드마크 좌표는 이미지 비율 0.0~1.0 (x: 좌=0 우=1, y: 상=0 하=1)**

### 📚 근거 논문 (Landmark Evidence Base)

| 논문 | 핵심 내용 |
|---|---|
| **Ferreira EAG et al. (2010)** Clinics (São Paulo) 65(7):675-681 | SAPO (Postural Assessment Software) — PubMed 등재, 17개 랜드마크 정의 및 검증. ICC 신뢰도 확인 |
| **Iunes DH et al. (2014)** PubMed — Photographic analysis of human posture | 랜드마크 선정 체계적 리뷰 — 사진측정에 적합한 랜드마크 권고 |
| **Shaghayegh Fard B et al. (2016)** J Bodyw Mov Ther | CVA 측정 기준 — Tragus + C7 기반 |
| **Kendall FP et al. (2005)** Muscles: Testing & Function 5th Ed. | Plumb Line 기준 및 각 랜드마크 정의 |
| **Reliability of photogrammetric evaluation (2025)** ResearchGate | ICC 0.98 — CVA, swayback, knee hyperextension |

---

### 정면 / 후면 (front / back)

| 랜드마크 키 | 해부학적 정확 위치 | 촬영 팁 | 논문 근거 |
|---|---|---|---|
| `leftEar` / `rightEar` | **귓구슬 (Tragus / Intertragic Notch)** — 귀 연골 앞쪽 작은 돌기 끝 | 귀 전체 중 가장 앞쪽 뾰족한 부분 | SAPO 2010, Iunes 2014 |
| `nose` | 코끝 (Mental protuberance 아님) | 정면에서 코 가장 앞 | — |
| `leftShoulder` / `rightShoulder` | **Acromion 중심점** — 견봉 가장 넓은 부분 중앙 | 어깨 가장 높은 외측 뼈 끝 | SAPO 2010 |
| `leftHip` / `rightHip` | **ASIS (전상장골극)** 정면 / **PSIS (후상장골극)** 후면 — 골반 앞/뒤 튀어나온 뼈 | 허리띠 라인 앞쪽 돌출부 | SAPO 2010, Mazhar 2021 |
| `leftKnee` / `rightKnee` | **슬개골 중심 (Patella midpoint)** | 무릎 앞 둥근 뼈 중앙 | SAPO 2010 |
| `leftAnkle` / `rightAnkle` | **외측복사뼈 (Lateral Malleolus)** — 발목 바깥쪽 뼈 돌출부 | 발목 바깥쪽 가장 튀어나온 부분 | SAPO 2010, Iunes 2014 |

> ⚠️ **ASIS/PSIS 주의:** 비만 환자는 피하지방으로 ASIS/PSIS가 잘 안 보임. 이 경우 Greater Trochanter(대전자)로 대체 가능 (Iunes 2014 권고)
...
| 랜드마크 키 | 해부학적 정확 위치 | 촬영 팁 | 논문 근거 |
|---|---|---|---|
| `ear` | **귓구슬 (Tragus)** — CVA 측정 상단 기준점 | 귀 앞쪽 작은 돌기 끝 | Shaghayegh Fard 2016 |
| `c7` | **C7 극돌기 (7번 경추 극돌기)** — CVA 측정 하단 기준점 | 고개 숙이면 목 뒤 가장 튀어나오는 뼈 | Shaghayegh Fard 2016, SAPO 2010 |
| `shoulder` | **Acromion 중심** — 견봉 외측 | 어깨 가장 높은 외측 뼈 | SAPO 2010 |
| `hip` | **Greater Trochanter (대전자)** — 고관절 외측 돌출부 | 허벅지 바깥쪽 손으로 만지면 볼록한 뼈 | SAPO 2010, Kendall 2005 |
| `knee` | **비골두 (Fibular head) / 외측 슬관절선** — 무릎 외측 | 무릎 바깥쪽 약간 아래 관절선 | SAPO 2010 |
| `ankle` | **외측복사뼈 (Lateral Malleolus)** — 발목 외측 돌출부 약간 전방 | 발목 바깥 뼈 돌출부 | SAPO 2010, Iunes 2014 |
...
```
정상 CVA > 50° (Shaghayegh Fard 2016)

측정: C7 극돌기 → Tragus 연결선 vs 수평선 사이 각도
...
각도가 클수록(수직에 가까울수록) = 정상
각도가 작을수록(수평에 가까울수록) = Forward Head Posture
```

---

### 랜드마크 시각화 색상 코드 (SpineChart 앱)

| 색상 | 랜드마크 | 해부학적 의미 |
|---|---|---|
| 🔵 파란색 `#00b4d8` | 귓구슬(Tragus), 코 | 두부 기준점 |
| 🟡 노란색 `#FFD600` | Acromion, C7 | 어깨/경추 기준점 |
| 🔴 빨간색 `#ff6b6b` | ASIS/PSIS, Greater Trochanter | 골반 기준점 |
| 🩵 청록 `rgba(0,180,216,.8)` | 슬개골 / Fibular head | 무릎 기준점 |
| ⚪ 연청 `#a8dadc` | Lateral Malleolus | 발목 기준점 |

**선 의미:**
- 초록 점선 → Plumb Line (수직 중력선, Lateral Malleolus 기준)
- 초록 실선 → 귀 수평선
- 노란 실선 → 어깨 수평선 (Kendall 2005)
- 빨간 실선 → 골반 수평선
